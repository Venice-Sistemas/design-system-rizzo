export interface CheckboxContractHarness {
...
/**
 * Executa a suíte de conformidade do Checkbox contra uma implementação.
 *
 * Usa os globais `describe`/`it`/`expect` do runner — Vitest, Jest e Jasmine os
 * fornecem, então o mesmo arquivo serve aos três.
 */
export declare function runCheckboxContract(harness: CheckboxContractHarness): void;
