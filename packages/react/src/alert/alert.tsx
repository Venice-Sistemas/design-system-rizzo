 ...
 *
 * A decisão central está em `urgent`, e ela separa duas coisas:
 *
 *   tone     é COR      — que família de feedback a mensagem pertence
 *   urgent   é ANÚNCIO  — se o leitor de tela interrompe o que está lendo
 *
 * `role="alert"` é região viva assertiva: interrompe na hora. Isso está certo
 * para uma falha que bloqueia a tarefa e errado para uma caixa informativa que já
 * nasce na tela — ela passa a interromper a leitura sem motivo, e quem enxerga
 * nunca percebe o defeito. Fixá-lo em todo alerta é o erro comum.
 *
